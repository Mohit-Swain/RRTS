...
# Form implementation generated from reading ui file 'adminstratior.ui'
#
...
class Ui_MainAdminstrator(object):
    def setupUi(self, MainSupervisor):
        ...
        self.label.setGeometry(QtCore.QRect(310, 0, 171, 41))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, MainSupervisor):
        ...
        MainSupervisor.setWindowTitle(_translate("MainSupervisor", "adminstrator main"))
        self.label.setText(_translate("MainSupervisor", "Adminstrator"))
        ...
        self.editButton.setText(_translate("MainSupervisor", "Edit Resources"))
    ...
    def editInfo(self,win):
        ...
        if idx is not None:
            try:
                editInfo = QtWidgets.QMainWindow(win)
                ui = Ui_AdminstrationWindow(self.schedule[idx])
                ui.setupUi(editInfo)
                editInfo.show()
